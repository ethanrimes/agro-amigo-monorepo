#!/bin/bash
# retry_errors.sh - Retry failed processing with logging
#
# Usage:
#   ./scripts/retry_errors.sh                         # Retry all errors
#   ./scripts/retry_errors.sh --error-type no_prices_extracted
...
RUN_NAME="retry_errors_${TIMESTAMP}"
RUN_PATH="$RUN_DIR/$RUN_NAME"

mkdir -p "$RUN_PATH"

LOG_FILE="$RUN_PATH/retry.log"
ERROR_LOG="$RUN_PATH/errors.log"

echo "=============================================="
echo "AgroAmigo Error Retry"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "Retry completed with exit code: $EXIT_CODE"
