            ...
            <section className="coffee-hero">
              <div className="coffee-hero-content">
                ...
                <p className="coffee-published">
                  Factor de rendimiento 94 · {money(data.price / 125)} por kg
                  <br />
            ...
            <div className="detail-grid">
              <div>
                ...
                <p className="privacy-note">
                  Serie diaria nacional FNC. Solo se muestran fechas publicadas;
                  no se completan vacíos con precios estimados.
                </p>
              ...
              <aside>
                <section className="panel calculator">
                  ...
                  <label className="form-field">
                    ...
                    <small>Usa el factor de tu análisis de trilla. <EvidenceLink id="fnc-price" page={1}>Ver tabla FNC</EvidenceLink></small>
                  </label>
                  <label className="form-field">
                    ...
                    />
                    <small>
                      Ingresa una cotización que hayas recibido para la misma
                      calidad. No publicamos ofertas de compradores.
                    </small>
                  </label>
                  <label className="form-field">
                  ...
                  <div className="calculation-result" aria-live="polite">
                    ...
                    <strong>
                      {valid
                        ? money(offered !== null ? offered - +cost : reference)
                        : "—"}
                    </strong>
                    {valid && (
                      <>
                        ...
                        {offered !== null ? (
                          <p>
                            Oferta bruta{" "}
                            {offered >= reference ? "por encima" : "por debajo"}{" "}
                            de la referencia:{" "}
                            {money(Math.abs(offered - reference))}.
                          </p>
                        ) : (
                          <p>
                            Referencia menos costos: {money(reference - +cost)}
                          </p>
                        )}
                      </>
                    )}
                  ...
                  {!valid && (
                    <p className="invalid-input">
                      Revisa los valores: cantidad y oferta deben ser positivas;
                      los costos pueden ser cero.
                    </p>
                  )}
                  <p className="privacy-note">
                    Cálculo orientativo con la tabla nacional. Bonificaciones,
                    calidad en taza y condiciones de entrega se acuerdan con el
                    comprador.
                  </p>
                </section>
                <div className="explain-card">
                  ...
                  <p>
                    ...
                    cambio y la prima del café colombiano. La calidad y el punto
                    de entrega también influyen.
                  </p>
                  {data.exchange && (
                    <p>
                      TRM: <strong>{money(data.exchange.price)} por USD</strong>
                      <br />
                      {dateLabel(data.exchange.date)} ·{" "}
                      <EvidenceLink id={data.exchange.document_id}>Superfinanciera</EvidenceLink>
                    </p>
                  )}
                  <Link href="/sources">Conoce las fuentes del café ↗</Link>
                </div>
              </aside>
            </div>
            <CoffeeCostReference/>
            <Link className="button secondary" href="/plan?tab=budget">Hacer el presupuesto de mi café →</Link>
            <div className="coffee-support">
              <div>
                <IoShieldCheckmarkOutline />
                <h3>Garantía de compra</h3>
                <p>
                  La red de cooperativas ofrece compra a precio de mercado. Es
                  una garantía de encontrar comprador, no un precio fijo para
                  cualquier café.
                </p>
              </div>
              <div>
                ...
                <p>
                  ...
                  bonificaciones pueden cambiar una oferta. Pergamino, cereza y
                  café tostado tienen unidades y condiciones distintas.
                </p>
              </div>
              <div>
                <IoLocationOutline />
                ...
                <p>
                  La tabla regional corresponde a entrega en Almacafé. Pregunta
                  en el punto de compra por transporte, acopio y descuentos
                  aplicables.
                </p>
              </div>
            </div>
