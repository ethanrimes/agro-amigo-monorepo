  ...
  return (
    <>
      <button
        ...
        onClick={() =>
          window.history.length > 1 ? router.back() : router.push("/sources")
        }
      >
        <IoArrowBack /> Volver
      </button>
      <div className="page-heading">
        <div>
          <span className="eyebrow">LA FUENTE, A LA VISTA</span>
          <h1>Comprueba el dato</h1>
          <p>Consulta el documento que respalda la información.</p>
        </div>
      </div>
      {loading ? (
        <div className="empty-state" role="status">
          Buscando el documento en Azure…
        </div>
      ) : error ? (
          ...
          <>
            ...
            <details className="source-explanation">
              ...
              <dl className="evidence-audit">
                ...
                <dt>{data.id.startsWith("weather-")?"Identificador de la consulta":"Identificador de integridad SHA-256"}</dt>
