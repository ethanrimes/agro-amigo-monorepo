...
function ProductDetail({ id }: { id: string }) {
  ...
  const { region, saved, toggleSaved } = usePreferences();
  ...
  const markets = [...(data?.markets || [])].sort(
    (a, b) => b.date.localeCompare(a.date) || b.price - a.price,
  );
  ...
  const valid =
    ...
    +transport >= 0;
  const total =
    selected && valid ? selected.price * +quantity - +transport : null;
  return (
    <>
            ...
            {mode === "supply" ? (
              ...
              <>
                <div className="page-heading">
                  <p>
                    Precios de venta mayorista, antes de costos de transporte.
                  </p>
                </div>
                <div className="detail-grid">
                  <div>
                    ...
                    <p className="privacy-note">
                      ...
                      cobertura puede cambiar.{" "}
                      <EvidenceLink id={"price-" + id}>
                        Comprobar precios en el documento
                      </EvidenceLink>
                    </p>
                    <Link className="button secondary" href="/daily">
                      Consultar precios del último boletín diario →
                    </Link>
                  ...
                  <aside>
                    <section className="panel calculator">
                      ...
                      <h2>Calcula el valor con transporte</h2>
                      ...
                      <label className="form-field">
                        ...
                        />
                        <small>
                          Gasto total a tu cargo para esta cantidad.
                        </small>
                      </label>
                      <div className="calculation-result" aria-live="polite">
                        <span>Al vender · valor menos transporte</span>
                        <strong data-result="sale">
                          {total !== null ? money(total) : "—"}
                        </strong>
                        <span>Al comprar · valor más transporte</span>
                        <strong data-result="purchase">
                          {total !== null ? money(total + 2 * +transport) : "—"}
                        </strong>
                        <p>
                          {selected
                      ...
                      {!valid && (
                        <p className="invalid-input">
                          Ingresa una cantidad positiva y costos de transporte
                          de cero o más.
                        </p>
                      )}
                      <p className="privacy-note">
                    ...
                    <div className="explain-card">
                      ...
                      <p>
                        ...
                        Compara el valor final después del transporte y confirma
                        las condiciones con quien compra.
                      </p>
                      <Link href="/offers">Compara tus ofertas →</Link>
                    </div>
                  </aside>
                </div>
                <Notice>
                  Los precios corresponden al mercado mayorista. No representan
                  el pago que recibe el productor en finca ni garantizan
