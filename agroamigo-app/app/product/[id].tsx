...
import Svg, { Polyline, Line, Text as SvgText, Defs, LinearGradient, Stop } from 'react-native-svg';
...
export default function ProductDetailScreen() {
  ...
  async function loadProduct() {
    try {
      const [prod, sup, mktPrices] = await Promise.all([
        getProductById(id!),
  ...
  // Shared date for market prices section
  ...
  return (
    <>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        {/* Supply */}
        <Card style={styles.chartCard}>
          <ExpandableSection title="Abastecimiento" icon="trending-up" initiallyExpanded={true}>
...
const styles = StyleSheet.create({
  ...
  timeRangeRow: { flexDirection: 'row', gap: spacing.xs, marginBottom: spacing.md },
  ...
  // Supply
  supplyStats: { flexDirection: 'row', gap: spacing.lg },
  supplyStat: {
    flex: 1, backgroundColor: colors.primary + '10', borderRadius: borderRadius.md,
    padding: spacing.md, alignItems: 'center', gap: 4,
  },
  supplyStatValue: { fontSize: fontSize.lg, fontWeight: '700', color: colors.primary },
